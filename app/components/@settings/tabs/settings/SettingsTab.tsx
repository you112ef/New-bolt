    ...
    <div className="space-y-3 sm:space-y-4">
      ...
      >
        ...
        <div>
          ...
          <div className="flex items-center justify-between">
            <span className="text-sm text-bolt-elements-textSecondary flex-1 pr-2">
      ...
      >
        ...
        <div className="space-y-2">
          <div className="flex items-center justify-between p-2 sm:p-3 rounded-lg bg-[#FAFAFA] dark:bg-[#1A1A1A]">
            ...
            <div className="flex items-center gap-1 flex-shrink-0 ml-2">
              <kbd className="px-1.5 sm:px-2 py-1 text-xs font-semibold text-bolt-elements-textSecondary bg-white dark:bg-[#0A0A0A] border border-[#E5E5E5] dark:border-[#1A1A1A] rounded shadow-sm">
